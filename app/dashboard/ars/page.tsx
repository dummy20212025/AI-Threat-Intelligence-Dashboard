...
import Arssidebar from "@/components/sidebar/arssidebar";

// Import your Sidebar component
import Athsidebar from "@/components/sidebar/athsidebar";
...
export default async function ACR() {
    ...
    return (
        /* MAIN WRAPPER: Flex row allows the sidebar and dashboard to sit side-by-side */
                ...
                <MDiv variants={itemVariants} className="w-full">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 md:gap-8">
                        ...
                        >
                            ...
                            <div className="transition-transform duration-500 group-hover:scale-[1.01] flex flex-col h-full">
                                <div className="mb-10 relative z-10">
                                    <h3 className="text-xl font-bold text-slate-800 ml-2 transition-colors duration-300 group-hover:text-blue-600">Anomaly</h3>
                        ...
                        >
                            ...
                            <div className="transition-transform duration-500 group-hover:scale-[1.01] flex flex-col h-full">
                                <div className="mb-10 relative z-10">
                                    <h3 className="text-xl font-bold text-slate-800 ml-2 transition-colors duration-300 group-hover:text-indigo-600">Port Scan</h3>
                                    <p className="text-sm text-slate-500 ml-2">Top Destination IP Records</p>
                                </div>
                                <div className="flex justify-center items-center pt-4">
                                    <div className="w-full max-w-[570px] h-[300px]">
