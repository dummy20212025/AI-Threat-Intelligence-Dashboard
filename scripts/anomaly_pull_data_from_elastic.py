...
def get_filename(timestring,prefix='anomaly'):
    ...
    for tt in time_range:
        ...
        try:
            ...
            query = {
                "query": {
                    ...
                    "filter": [
                        ...
                        { "term": {"@type.keyword": "Flow_Anomaly" } },
                    ],
                    "should": [],
                    "must_not": []
                    }
            ...
            for message in results:
                ...
                obj['SourceIP'] = source.get('src')
                obj['SrcPort'] = source.get('src_port_flow')
                obj['DstIP'] = source.get('dst')
                obj['DstPort'] = source.get('dst_port_flow')
                obj['Protocol'] = source.get('c4_flow')
                obj['tcpFlagsSequence'] = source.get('tcpFlagsSequence')
                obj['tcpSynTotalCount'] = source.get('tcpSynTotalCount')
                obj['tcpRstTotalCount'] = source.get('tcpRstTotalCount')
                obj['tcpPshTotalCount'] = source.get('tcpPshTotalCount')
                obj['tcpAckTotalCount'] = source.get('tcpAckTotalCount')
                obj['tcpUrgTotalCount'] = source.get('tcpUrgTotalCount')
                obj['Duration'] = source.get('duration')
...
if __name__=="__main__": 
    ...
    final_df.to_csv("anomaly.csv",index=False)
