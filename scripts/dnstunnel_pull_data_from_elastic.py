...
def get_filename(timestring,prefix='dnstunnel'):
...
def main():
    ...
    time_range = [
        ['10.02.2026 11:10:00','10.02.2026 13:30:00']
        ]
    # time_range = [
    #    date_time
    #    ]
    ...
    for tt in time_range:
        ...
        try:
            ...
            for message in results:
                ...
                obj['AttackerPort'] = source.get('dns_attackerPort')
                obj['VictimPort'] = source.get('dns_victimPort')
                obj['Victim'] = source.get('victim')
                obj['DnsQName'] = source.get('dnsQName')
...
if __name__=="__main__": 
    ...
    final_df.to_csv("dnstunnel.csv",index=False)
